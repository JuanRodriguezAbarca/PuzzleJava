...
Feature: As a customer, I want to select the type of car I want to sell, so that I can receive an offer from Company that I can receive, an offer from auto1.com
  ...
  @TestThePuzzle
  Scenario Outline: Testing the different combinations of models and dates for
